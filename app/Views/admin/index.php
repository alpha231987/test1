<?= $this->extend('Admin/template/MasterTemplate'); ?>
        ...
        <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                    <div class="card-body">
                        <img src="<?php echo base_url('assets_admin'); ?>/images/dashboard/circle.svg"
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="<?php echo base_url('assets_admin'); ?>/images/faces/face1.jpg"
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<?php echo base_url('assets_admin'); ?>/images/faces/face2.jpg"
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<?php echo base_url('assets_admin'); ?>/images/faces/face3.jpg"
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<?php echo base_url('assets_admin'); ?>/images/faces/face4.jpg"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-6 pe-1">
                                <img src="<?php echo base_url('assets_admin'); ?>/images/dashboard/img_1.jpg"
                                    class="mb-2 mw-100 w-100 rounded" alt="image">
                                <img src="<?php echo base_url('assets_admin'); ?>/images/dashboard/img_4.jpg"
                                    class="mw-100 w-100 rounded" alt="image">
                            </div>
                            <div class="col-6 ps-1">
                                <img src="<?php echo base_url('assets_admin'); ?>/images/dashboard/img_2.jpg"
                                    class="mb-2 mw-100 w-100 rounded" alt="image">
                                <img src="<?php echo base_url('assets_admin'); ?>/images/dashboard/img_3.jpg"
                                    class="mw-100 w-100 rounded" alt="image">
                            </div>
                        </div>
