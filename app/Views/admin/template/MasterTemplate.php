...
<html lang="en">
  ...
  <body>
    ...
    <script src="<?php echo base_url('assets_admin'); ?>/vendors/chart.js/chart.umd.js"></script>
    <script src="<?php echo base_url('assets_admin'); ?>/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
    ...
    <script src="<?php echo base_url('assets_admin'); ?>/js/settings.js"></script>
    <script src="<?php echo base_url('assets_admin'); ?>/js/todolist.js"></script>
    <script src="<?php echo base_url('assets_admin'); ?>/js/jquery.cookie.js"></script>
    <!-- endinject -->
